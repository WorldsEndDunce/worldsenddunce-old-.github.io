...
Collaborated with a team to build a web application to make language conversation practice more accessible, featuring ChatGPT-powered talking cat baristas. Uses HTML/CSS/JS, Python, and OpenAI's GPT-3 and Whisper APIs.
